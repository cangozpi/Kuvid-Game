...
public class SigmaBetaPowerUpObject extends GameObject{
    private int angle;
    private String imageSource = "sigma-b.png";

    public SigmaBetaPowerUpObject(Coordinate coordinate, int WIDTH, int HEIGHT, int angle) {
        super(coordinate, WIDTH, HEIGHT, "sigma-b.png");
        this.angle = angle;
    }
