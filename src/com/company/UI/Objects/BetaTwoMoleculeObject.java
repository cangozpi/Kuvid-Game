...
public class BetaTwoMoleculeObject extends GameObject{
    private int angle;
    private String imageSource = "beta-2.png";

    public BetaTwoMoleculeObject(Coordinate coordinate, int WIDTH, int HEIGHT, int angle) {
        super(coordinate, WIDTH, HEIGHT, "beta-2.png");
        this.angle = angle;
    }
