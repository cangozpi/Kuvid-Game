...
public class AlphaOneMoleculeObject extends GameObject{
    private int angle;
    private String imageSource = "alpha-1.png";

    public AlphaOneMoleculeObject(Coordinate coordinate, int WIDTH, int HEIGHT, int angle) {
        super(coordinate, WIDTH, HEIGHT, "alpha-1.png");
        this.angle = angle;
    }
