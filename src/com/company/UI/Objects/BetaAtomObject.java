...
public class BetaAtomObject extends GameObject{
    private int angle;
    private String imageSource = "beta.png";

    public BetaAtomObject(Coordinate coordinate, int WIDTH, int HEIGHT, int angle) {
        super(coordinate, WIDTH, HEIGHT, "beta.png");
        this.angle = angle;
    }
